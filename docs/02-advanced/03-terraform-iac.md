...
### 5.4 Terraform状态管理底层原理深度解析

**Terraform是怎么管理基础设施状态的？**
...
│  问题场景：                                                      │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │  开发者A执行 terraform apply                           │   │
│  │  ├── 读取状态文件                                       │   │
│  │  ├── 开始创建资源...                                     │   │
│  │                                                          │   │
│  │  开发者B同时执行 terraform apply                        │   │
│  │  ├── 读取状态文件（旧版本）                             │   │
│  │  ├── 开始创建资源...                                     │   │
│  │                                                          │   │
│  │  结果：状态冲突，资源重复创建或丢失                      │   │
